...
function DashBoard() {
  return (
    <div className=" p-6">
      ...
      <div className="p-6 relative flex flex-col min-w-0 mb-12 lg:mb-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
      ...
      <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between mb-4 items-start">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]" data-popper-id="popper-10" data-popper-placement="bottom-end" style={{position: "absolute", inset: "0px 0px auto auto" , margin: "0px", transform: "translate3d(-49px, 1688px, 0px)"}}>
                                <li>
